      ...
      <div class="bg-white rounded-[calc(1rem-2px)] md:rounded-[calc(1.5rem-2px)] p-4 sm:p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
          <button 
            ...
            class="w-full md:w-auto px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold bg-[#876D5A] text-white hover:bg-[#725a49] active:scale-95 shadow-xs transition duration-200 flex items-center justify-center gap-2 cursor-pointer"
          >
      ...
      <div class="bg-white rounded-t-3xl md:rounded-3xl shadow-2xl max-w-4xl w-full flex flex-col md:flex-row overflow-hidden max-h-[90vh] relative border border-white/20">
        ...
        <div :class="['w-full md:w-1/2 bg-[#FAF4EE]/40 p-4 sm:p-6 overflow-y-auto border-r border-gray-200', mobileModalTab === 'appts' ? 'block' : 'hidden md:block']">
          ...
          <div class="flex items-center justify-between mb-3">
            <h4 class="font-bold text-gray-800 flex items-center gap-2 text-sm md:text-base">
              <Icon name="mdi:calendar-check" class="text-emerald-700" size="18"/> 
              當日預約名單
            </h4>
            <button 
              @click="openManualBookingModal(selectedDay.fullDate)"
              class="text-xs bg-[#876D5A] text-white hover:bg-[#725a49] px-2.5 py-1 rounded-xl font-bold transition flex items-center gap-1 cursor-pointer shadow-2xs active:scale-95"
            >
